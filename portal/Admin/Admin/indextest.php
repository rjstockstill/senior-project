        ...
        <div class="container-fluid">
            ...
            <div class="main" style="overflow-y:scroll;">
                    ...
                    <table class="table table-hover table-striped table-bordered nowrap">
                        ...
                        <tbody>
                          <tr>
                              ...
                              <td><?php echo $row['user_id'];?></td>
                              <td><a href="<?php echo "file:///Users/krys/.bitnami/stackman/machines/xampp/volumes/root/htdocs/MLS/User/" . $row['file'];?>">Photo Identification</a></td>
                ...
                <div class="manageMedicine hidden" id="hiddenMedicine">
                    ...
                    <table class="table table-hover table-striped table-bordered nowrap medicine-table">
                        <thead>
                          <tr>
                              <th scope="col">ID</th>
...
<div class="block-modal" style="display: none">
                ...
                <div class="view-user-modal" style="display:none">
                        <div class="view-user-modal-content">
                            <div class="closeViewUser">X</div>
            ...
            $viewUser->store_result(); 
            if($viewUser->num_rows > 0){ 
               $viewUser->bind_result($viewUserAcc_id, $viewsserName, $viewfirst_name, $viewlast_name, $viewuserType, $viewstatus, $viewcity, $viewstate, $viewzip, $viewaddress1, $viewaddress2, $viewdob, $viewcreated); 
    ...
    echo "Error viewing information";
                             ...
                             if ($userType == 1){
                                    ...
                                    $uType = "Invalid";
                                      ...
                                      ?>
                                User ID: <?php echo $viewuserAcc_id ?><br>
                                Username: <?php echo $viewuserName ?><br>
                                First Name: <?php echo $first_name ?><br>
                                Last Name: <?php echo $viewlast_name ?><br>
                                Created: <?php echo $viewcreated ?><br>
                                Account Type: <?php echo $uType ?><br>
                                Status: <?php echo $viewstatus ?><br>
                                Address: <?php echo $viewaddress1 ." ". $viewaddress2 ?><br>
                                City: <?php echo $viewcity ?><br>
                                State: <?php echo $viewstate ?><br>
                                Zip: <?php echo $viewzip ?><br>
                                Created: <?php echo $viewcreated; }}?><br>
  ...
  <!-- Modal -->
  <div class="modal fade view-user-modal" id="myModal" role="dialog">
    <div class="modal-dialog">
    
      <!-- View User content-->
      <div class="modal-content view-user-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">Close</button>
          
        </div>
        <div class="modal-body view-user-modal-body">
          User ID: <span id="viewuserID"></span><br>
          Username: <span id="viewuserName"></span><br>
                        ...
                        method: "GET",
                            data: {"userAcc_id": selectedUserID},
                                success: function(response){
                                    ...
                                    $("#viewType").text(user.type);
                                    $("#viewstatus").text(user.status);
                                    $("#viewaddress").text(user.address1);
