...
<html>
                        ...
                        <tbody>
                          <tr>
                              ...
                              <td>
                                  ...
                                  <a href="indextest.php?action=block&userAcc_id=<?php echo $row['userAcc_id'];?>"> Block</a>   
                              </td>
                            </tr>
                        </tbody>
                        <?php endwhile; ?>
                        ...
                        <tbody>
                          <tr>
                              ...
                              <td>
                                  ...
                                  <a href="indextest.php?action=viewMedDetail&med_id=<?php echo $row['med_id'];?>">View Details</a>    
                              </td>
                            </tr>
                        </tbody>
                        <?php endwhile; ?>
 ...
 <!-----Manage Pharmacies--->
				...
				<td><?php echo $row['pharm_zip'];?></td>
                              ...
                              <td>
                                  <a id="block-button" href="indextest.php?action=delete&pharm_id=<?php echo $row['pharm_id'];?>"> Remove</a>    
                              </td>
                            </tr>
                        </tbody>
                        <?php endwhile; ?>
